...
const GermanyPage = () => {
    ...
    return (
            ...
            >
              ...
              Unmatched Expertise and Commitment
                        ...
                        <p className="text-[20px] text-[#5C5C5C] mb-3">
                            Expert Assignments Writing Service in Germany with AI-free Commitment
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                <p className="text-center text-black mb-2 text-lg font-medium">
                                    AI-Free Assignment Help From 7000+ Real Experts in Germany
                                </p>
        ...
        "
                ...
                // }}
                >
                    How We operate: Our Online Assignment Help Service Workflow in Germany
                </h2>
