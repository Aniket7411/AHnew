...
const Ireland = () => {
    ...
    return (
            ...
            >
              ...
              Unmatched Expertise and Commitment
                        ...
                        <p className="text-[20px] text-[#5C5C5C] mb-3">
                            Expert Assignments Writing Service in Ireland with AI-free Commitment
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                <p className="text-center text-black mb-2 text-lg font-medium">
                                    AI-Free Assignment Help From 7000+ Real Experts in Ireland
                                </p>
        ...
        "
                ...
                // }}
                >
                    How We operate: Our Online Assignment Help Service Workflow in Ireland
                </h2>
                <div className="flex justify-center gap-2 align-center flex-wrap px-6">
                    ...
                    >
                        ...
                        <h1 className="font-bold mb-2">Submit Your Inquiry</h1>
