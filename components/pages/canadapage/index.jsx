...
const CanadaPage = () => {
    ...
    return (
            ...
            >
              ...
              Unmatched Expertise and Commitment
                        ...
                        <p className="text-[20px] text-[#5C5C5C] mb-3">
                            Expert Assignments Writing Service in Canada with AI-free Commitment
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                <p className="text-center text-black mb-2 text-lg font-medium">
                                    AI-Free Assignment Help From 7000+ Real Experts in Canada
                                </p>
        ...
        "
                ...
                // }}
                >
                    How We operate: Our Online Assignment Help Service Workflow in Canada
                </h2>
